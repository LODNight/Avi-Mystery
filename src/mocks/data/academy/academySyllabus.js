    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            topicId: 'topic-009',
            title: 'Thống kê có điều kiện với COUNTIF & SUMIF',
            duration: '18 phút',
            difficulty: 'Trung cấp',
            checkpointQuiz: {
              question: 'Hàm nào sau đây đếm số lượng giao dịch bất thường (vượt quá 10 triệu)?',
              options: [
                '=SUMIF(D2:D100, ">10000000")',
                '=COUNTIF(D2:D100, ">10000000")',
                '=IF(D2:D100 > 10000000, COUNT(), 0)',
                '=COUNT(D2:D100)',
              ],
              correctIndex: 1,
              explanation: 'Hàm COUNTIF dùng để đếm số ô thỏa mãn điều kiện nhất định (ở đây là ">10000000").',
            },
          },
        ],
      },
    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            topicId: 'topic-010',
            title: 'Tổng hợp & Phân nhóm với GROUP BY & HAVING',
            duration: '20 phút',
            difficulty: 'Trung cấp',
            checkpointQuiz: {
              question: 'Sự khác biệt chính giữa WHERE và HAVING là gì?',
              options: [
                'HAVING chỉ dùng với lệnh UPDATE',
                'WHERE lọc dữ liệu trước khi gom nhóm, HAVING lọc dữ liệu sau khi gom nhóm',
                'WHERE dùng cho chữ, HAVING dùng cho số',
                'Không có sự khác biệt, chúng thay thế nhau',
              ],
              correctIndex: 1,
              explanation: 'WHERE dùng để lọc từng bản ghi trước khi thực hiện GROUP BY, còn HAVING lọc các nhóm kết quả đã được tổng hợp.',
            },
          },
        ],
      },
